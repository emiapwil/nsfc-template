...
\section{项目的立项依据\note{研究意义、国内外研究现状及发展动态分析，需结合科学
    研究发展趋势来论述科学意义；或结合国民经济和社会发展中迫切需要解决的关键科技
    问题来论述其应用前景。附主要参考文献目录}；}
...
\begin{spacing}{1.3} % 行距
	\zihao{5}
	\bibliographystyle{../iNSFC/gbt7714-nsfc.bst}
	\bibliography{../iNSFC/ref.bib}
	\vspace{11bp}
\end{spacing}
...
\begin{figure*}[htb!]
	\centering
	\subfloat[\kaishu 涅尓瓦]{\includegraphics[width=0.17\textwidth]{"../iNSFC/images/Nerva"}\label{subfig:Nerva}
	}
	\subfloat[图拉真]{\includegraphics[width=0.17\textwidth]{"../iNSFC/images/Traianus"}\label{subfig:Traianus}
	}
	\subfloat[哈德良]{\includegraphics[width=0.17\textwidth]{"../iNSFC/images/Hadrian"}\label{subfig:Hadrian}
	}
	\subfloat[安敦尼\ 庇护]{\includegraphics[width=0.17\textwidth]{"../iNSFC/images/Antoninus_Pius"}\label{subfig:Antoninus_Pius}
	}
	\subfloat[马可\ 奥勒留]{\includegraphics[width=0.17\textwidth]{"../iNSFC/images/Marcus_Aurelius"}\label{subfig:Aurelius}
	}
	\caption{罗马帝国五贤帝.}
	\label{fig:Rome}
\end{figure*}
...
\bibliographystylepub{../iNSFC/gbt7714-nsfc.bst}
\bibliographypub{../../cv/publication.bib}
